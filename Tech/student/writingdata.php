...
$sql = "SELECT * FROM `student` ORDER BY tag DESC ";

$result = mysqli_query($connect,$sql);
$num_rows = mysqli_num_rows($result);
if($_SESSION['id'] != null ) {
    $id = $_SESSION['id'];
    echo "<a href='student/writingRe.php'><button class=\"button button1\" >新增</button></a> <br>";
}
echo " 共有 $num_rows 項 \n";
...
<!--        $count1.-->
        ...
        <tr>
        <td width="6%" style="text-align:center;"><?php echo "$row[1]" ?>
            <?php
            if($_SESSION['id'] != null )
            {
                $id = $_SESSION['id'];
                ...
                ?>
            <br>
                <form name="form" method="post" action="student/writing_update.php">
                    <?php
                ...
                <br>
                <form name="form" method="post" action="student/writing_delete_finish.php">
                    <?php
                    echo"<input  type=\"hidden\" name=\"tag\" value=\"$row[0]\" />";
                    ?>
        ...
        <td width="60%"><?php echo "$row[4]" ?></td>
        <td width="15%"><?php echo "$row[5]" ?>
           </td>
