...
<!--        remark                      -->
        <div class="form-group">
            ...
            <textarea class="form-control"  name="schoolyear" rows="3"></textarea>
        </div>
        <div class="form-group">
            <label> 系所(department)：</label>
            <textarea class="form-control"  name="department" rows="3"></textarea>
        </div>
        <div class="form-group">
            <label> 姓名(name)：</label>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control"  name="thesis" rows="3"></textarea>
